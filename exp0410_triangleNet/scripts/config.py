...
class Config:
    ...
    # depth = number of neurons at each position
    # int: same depth for all layers (e.g., depth=1 means 1 neuron per position)
    # "tetrahedron": depth(z) = z, forms a tetrahedron structure
    depth: int | str = 1
