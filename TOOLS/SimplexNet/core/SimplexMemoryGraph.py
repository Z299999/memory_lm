...
This module provides the graph structure for Simplex Memory Networks.
It builds a directed acyclic graph (DAG) from a simplicial lattice
with potential-based edge orientation.
...
Usage::
    ...
    # Access properties
    print(f"Core nodes: {graph.core_node_count}")
    print(f"Edges: {graph.edge_count}")
    print(f"Topological levels: {graph.topological_levels}")
"""
