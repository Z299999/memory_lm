...
- 本地 dashboard：
  ...
  - [server.py](/Users/shzhang/Documents/Codes/memory_lm/experiments/exp0513_sigmaAlgAddrDopamine/server.py)
...
当前默认网络是 `1 -> 16 -> 16 -> 1`，所以 hidden pool 大小是 `32`。  
按当前推荐规则：
...
- 中间显示 `1 -> 16 -> 16 -> 1` 的 forward network
